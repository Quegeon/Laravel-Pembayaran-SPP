...
<body onload="window.print()">
    ...
    <div class="container">
        ...
        <div class="container-right">
            ...
            <h4>  {{ $pembayaran->Siswa->Kelas->nama_kelas }}</h4>
            <h4>  {{ $pembayaran->SPP->keterangan }}</h4>
            <h4>  Rp. {{ $pembayaran->SPP->nominal }}</h4>
            <h4>  {{ $pembayaran->tahun }}</h4>
            <h4>  {{ $pembayaran->tgl_bayar }}</h4>
            <h4>  Rp. {{ number_format($pembayaran->jumlah_bayar) }}</h4>
            <h4>  {{ $pembayaran->User->nama_petugas }}</h4>
